...
public class PGif : MonoBehaviour
{
    ...
    /// (Reminded: the transparent feature takes more time to encode the GIF. So only enable it when you are going to create a transparent background gif)
    /// </summary>
...
#region ----- Static methods -----
	...
	{
		Instance.SetTransparent(color32, transparentColorRange);
	}
