...
namespace Assets.GifAssets.PowerGif
{
	...
	public class Gif
	{
        ...
        static Gif()
        {
            SimpleGif.Gif.Multithreading = Application.platform != RuntimePlatform.WebGLPlayer;
        }
		...
		/// </summary>
		public static Gif Decode(byte[] bytes, FilterMode filterMode = FilterMode.Bilinear)
		{
			var frames = Converter.ConvertFrames(SimpleGif.Gif.Decode(bytes).Frames, filterMode);
