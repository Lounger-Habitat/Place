...
namespace Assets.GifAssets.PowerGif
{
	...
	public static class Converter
	{
		...
		/// </summary>
		public static List<GifFrame> ConvertFrames(List<SimpleGif.Data.GifFrame> frames, FilterMode filterMode = FilterMode.Bilinear)
		{
			return frames.Select(i => new GifFrame(ConvertTexture(i.Texture, filterMode), i.Delay)).ToList();
		}
		...
		public static Texture2D ConvertTexture(SimpleGif.Data.Texture2D source, FilterMode filterMode = FilterMode.Bilinear)
		{
